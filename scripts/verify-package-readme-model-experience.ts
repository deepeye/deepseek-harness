...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/service-app': { kind: 'none', reason: 'The bundle is a patch-list carrier that inserts the webserver and task-service rows; prompts and tools belong to the composed base layer.' },
  'packages/api/task-service': { kind: 'none', reason: 'The HTTP surface submits each task as an ordinary user message; prompts and tools belong to the composed base layer.' },
