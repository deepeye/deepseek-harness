/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-service-app`.
 * @module @deepseek-ai/dsh-service-app/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-service-app'

/** Cordis companion plugin name. */
export const name = 'service-app-bundle-invariant'
