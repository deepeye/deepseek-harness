...
import {
  BrandWordmark, FoxLogo, IconNewChatOutline16, IconPanelLeftOutline16, Tooltip,
  ...
  return (
    ...
    >
      <div className={css.logoRow}>
          ...
          >
            <span className={css.brandIdentity} aria-hidden="true">
              <span className={css.brandMark}>
                {renderSlot('sidebar.brand.mark', { size: 24 }, { fallback: <FoxLogo size={24} /> })}
              </span>
        ...
        {/* Rail resting state is the fox mark; hovering swaps in the panel
