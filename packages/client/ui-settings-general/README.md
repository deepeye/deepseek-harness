---
description: "Settings shell and ownerless copy for the dsh web client: the General section, trigger chrome, and onboarding ledger projection."
...
**Runtime invariant:** No companion is published. Slot conflicts fail loud in the slot core. The local document action is browser state over typed RPC responses and is covered by store/component tests rather than a Cordis runtime relationship.
